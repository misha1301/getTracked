    ...
    <BasicBlock>
      <Stack gap='20px'>
        ...
        <Text textStyle='2xl' fontWeight='bold'>
          {t('loginPage.loginForm.formLable')}
        </Text>
        <Stack gap='16px'>
          <Stack gap='8px'>
            <Field.Root>
              <Field.Label fontWeight='normal'>
                {t('loginPage.loginForm.emailFieldLable')}
              </Field.Label>
            ...
            <Field.Root>
              <Field.Label fontWeight='normal'>
                {t('loginPage.loginForm.passwordFieldLable')}
              </Field.Label>
          ...
          <Stack gap='23px'>
            <ButtonCustom>{t('loginPage.loginForm.submitButton')}</ButtonCustom>
            <DividerLine>
              <Text padding='0px 8px' color='#464646' textStyle='sm'>
                {t('loginPage.loginForm.dividerLable')}
              </Text>
            </DividerLine>
            <ButtonCustom variant='outline' onClick={() => navigate('/register')}>
              {t('loginPage.loginForm.goToButton')}
            </ButtonCustom>
          </Stack>
        </Stack>
      </Stack>
